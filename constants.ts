...
export const INITIAL_SOURCES: MediaSource[] = [
  // Default Active "Starter Pack" (6 sources) - balanced across leanings
  ...
  // Additional Sources (inactive by default, can be enabled in Sources tab)
  { id: '1', domain: 'kayhan.ir', name: 'Kayhan', leaning: 'Principlist', active: false, description: 'One of the most conservative newspapers in Iran, directly supervised by the Office of the Supreme Leader. Known for its hardline stance against the West and reformists.' },
  { id: '4', domain: 'resalat-news.com', name: 'Resalat', leaning: 'Principlist', active: false, description: 'A conservative daily newspaper associated with the Islamic Coalition Party and the bazaar merchants.' },
  { id: '5', domain: 'afkarnews.com', name: 'Afkar News', leaning: 'Principlist', active: false, description: 'A conservative news agency focusing on political and social analysis from a Principlist perspective.' },
  { id: '6', domain: 'irannewspaper.ir', name: 'Iran Newspaper', leaning: 'State', active: false, description: 'The official daily newspaper of the government, published by IRNA. It generally reflects the views of the sitting administration.' },
  { id: '7', domain: 'jamejamonline.ir', name: 'Jame Jam', leaning: 'State', active: false, description: 'Published by the IRIB (state broadcaster), focusing on social and cultural issues with a conservative, state-aligned viewpoint.' },
  { id: '10', domain: 'ettelaat.com', name: 'Ettelaat', leaning: 'Moderate', active: false, description: 'One of the oldest newspapers in Iran. Traditionally conservative but now seen as moderate/centrist, often publishing diverse viewpoints.' },
  { id: '11', domain: 'etemadonline.com', name: 'Etemad', leaning: 'Reformist', active: false, description: 'A prominent reformist newspaper. Often critical of hardline policies and advocates for social and political reforms.' },
  { id: '13', domain: 'aftabyazdonline.ir', name: 'Aftab Yazd', leaning: 'Reformist', active: false, description: 'A reformist newspaper covering political, social, and cultural news with a critical lens.' },
  { id: '14', domain: 'nournews.ir', name: 'Nour News', leaning: 'State', active: false, description: 'Affiliated with the Supreme National Security Council (SNSC). A key source for security and defense-related news.' },
  { id: '16', domain: 'armanmeli.ir', name: 'Arman Meli', leaning: 'Reformist', active: false, description: 'A reformist daily newspaper discussing social and political issues, supporting the reform movement.' },
  { id: '17', domain: 'hammihanonline.ir', name: 'Hammihan', leaning: 'Reformist', active: false, description: 'A reformist newspaper that has faced bans and reopenings. Known for its pro-reform editorial line.' },
];
